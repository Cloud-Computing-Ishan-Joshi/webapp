...
build {
  ...
  provisioner "shell" {
    # script = "/home/ishanjoshi7i/cloud-computing/webapp/machine_image/packer/scripts/install.sh"
  ...
  provisioner "shell" {
    ...
    # script = "/home/ishanjoshi7i/cloud-computing/webapp/machine_image/packer/scripts/postprocess.sh"
  }
}
